...
import cc.task3.pomodroid.factories.ActivityFactory;
import cc.task3.pomodroid.persistency.Service;
import cc.task3.pomodroid.services.TracTicketFetcher;
...
public class Services extends SharedActivity {
	...
	/**
	 * 
	 * @see cc.task3.pomodroid.SharedActivity#onCreate(android.os.Bundle)
	 */
	@Override
